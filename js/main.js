...
//pseudo-global variables
    var attrArray = ["Alzheimer's_disease","Cancer","Diabetes","Diseases_of_Heart", "Stroke", "Suicide"]; //list of attributes
...
function setMap(){
	...
	d3.csv("data/death2015.csv").then(function(csvData) {
		console.log(csvData)
		//add topojson
	d3.json("data/death2015.topojson").then(function(data2){
		console.log(data2);
		
		//Map specifications 
				
		//conversion of data
		var topjsonData = topojson.feature(data2, data2.objects.death2015).features;
			//check conversion of topojson
		console.log(topjsonData);
		
				
		//join csv data to GeoJSON enumeration units
        topjsonData = joinData(topjsonData, csvData);
	...
	function joinData(topjsonData, csvData){
		...
		for (var i=0; i<csvData.length; i++){
			...
			for (var a=0; a<topjsonData.length; a++){
				var geojsonProps = topjsonData[a].properties;//the current region geojson properties
	...
	function setEnumerationUnits(topjsonData, map, path, colorScale){
